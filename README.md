# Rust Insight Pairing Tool - Source Code

This repository contains the **complete source code** for the Rust Insight Pairing Tool. This is provided for transparency so users can verify exactly what the application does before downloading.

## What This App Does

The Rust Insight Pairing Tool is an Electron-based desktop application that:
...
4. **Syncs to cloud (optional)** - If logged in, syncs your paired data to the Rust Insight web app

## What This App Does NOT Do

- ❌ **Does NOT access any files** outside its own storage folder
- ❌ **Does NOT run system commands** or execute external programs
- ❌ **Does NOT send data anywhere** except the official Rust Insight web app (www.rustinsight.net)
...
| Lines | Purpose |
|-------|---------|
| 6-9 | **Imports** - Uses official Electron APIs and the Rust Insight core pairing library |
...
| 94-173 | **Cloud login** - Opens a popup to the Rust Insight web app for Google login |
...
| 450-491 | **Cloud sync** - Sends paired data to the Rust Insight API |

**Key URLs used:**
- `https://companion-rust.facepunch.com/login` - Official Facepunch Steam login
- `https://www.rustinsight.net` - Rust Insight web app
...
```bash
# Clone this repo
git clone https://github.com/TheShadew/Rust-Insight-Pairing-Tool-v1.0.0.git
...
**Note:** Building requires the `@rust-insight/core` package which handles the Rust+ protocol communication. This is part of the main Rust Insight monorepo.

## Downloads

Pre-built releases are available on the [Releases page](https://github.com/TheShadew/Rust-Insight-Pairing-Tool-v1.0.0/releases).
...
**This source code is provided for transparency. The main Rust Insight project is maintained separately.**
